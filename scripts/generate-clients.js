...
const prefixedStringType = codama.sizePrefixTypeNode(codama.stringTypeNode('utf8'), u32);
...
const joinedRunType = item => codama.sizePrefixTypeNode(codama.arrayTypeNode(item, codama.remainderCountNode()), u32);
    ...
    codama.bottomUpTransformerVisitor([
                ...
                definedTypes: [
                    ...
                    codama.definedTypeNode({
                        ...
                        type: codama.enumTypeNode(
                            SCHEMA_DATA_TYPE_VARIANTS.map(variant => codama.enumEmptyVariantTypeNode(variant)),
                        ),
                    }),
                ],
            }),
        ...
        ...INSTRUCTIONS_TAKING_LAYOUT.map(instruction => ({
            ...
            transform: node => {
                ...
                return {
                    ...node,
                    type: codama.arrayTypeNode(schemaDataTypeLink, codama.prefixedCountNode(u32)),
                };
            },
        })),
        {
