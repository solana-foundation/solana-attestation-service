...
/** AttestationDataTooLarge: Compressed Attestation data size exceeds maximum allowed (550 bytes) */
export const SOLANA_ATTESTATION_SERVICE_ERROR__ATTESTATION_DATA_TOO_LARGE = 0xd; // 13

export type SolanaAttestationServiceError =
  | typeof SOLANA_ATTESTATION_SERVICE_ERROR__ATTESTATION_DATA_TOO_LARGE
...
if (process.env.NODE_ENV !== 'production') {
  solanaAttestationServiceErrorMessages = {
    [SOLANA_ATTESTATION_SERVICE_ERROR__ATTESTATION_DATA_TOO_LARGE]: `Compressed Attestation data size exceeds maximum allowed (550 bytes)`,
