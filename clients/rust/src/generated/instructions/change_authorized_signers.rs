...
impl ChangeAuthorizedSigners {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(self.credential, false));
...
impl ChangeAuthorizedSignersBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args =
            ChangeAuthorizedSignersInstructionArgs { signers: self.signers.clone().expect("signers is not set") };
...
impl<'a, 'b> ChangeAuthorizedSignersCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(*self.credential.key, false));
