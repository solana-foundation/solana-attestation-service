...
impl CloseTokenizedAttestation {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(self.attestation, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(self.event_authority, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(self.system_program, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(self.attestation_program, false));
        accounts.push(solana_program::instruction::AccountMeta::new(self.attestation_mint, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(self.sas_pda, false));
        accounts.push(solana_program::instruction::AccountMeta::new(self.attestation_token_account, false));
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        let accounts = CloseTokenizedAttestation {
            ...
            attestation_program: self
                .attestation_program
                .unwrap_or(solana_program::pubkey!("22zoJMtdu4tQc2PzL74ZUT7FrwgB1Udec8DdW4yw4BdG")),
            attestation_mint: self.attestation_mint.expect("attestation_mint is not set"),
            sas_pda: self.sas_pda.expect("sas_pda is not set"),
            attestation_token_account: self.attestation_token_account.expect("attestation_token_account is not set"),
            token_program: self
                .token_program
...
impl<'a, 'b> CloseTokenizedAttestationCpi<'a, 'b> {
    ...
    pub fn invoke_signed_with_remaining_accounts(
        ...
        accounts.push(solana_program::instruction::AccountMeta::new(*self.attestation.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(*self.event_authority.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(*self.system_program.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(*self.attestation_program.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new(*self.attestation_mint.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new_readonly(*self.sas_pda.key, false));
        accounts.push(solana_program::instruction::AccountMeta::new(*self.attestation_token_account.key, false));
